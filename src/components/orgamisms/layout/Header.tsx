...
export const Header: VFC = memo(() => {
    ...
    return (
        <>
            ...
            <MenuDrawer isOpen={isOpen} onClose={onClose} onClickHome={onClickHome} onClickSetting={onClickSetting} onClickUserManagement={onClickUserManagement} onClickLogout={onClickLogout} />
        </>
    )
})